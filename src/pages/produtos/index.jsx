...
const Produtos = () => {
    ...
    const { produtosSelecionados, setBebidasSelecionadas, setItensDaMarmita, mostraAlertaProdutos } = useContext(ProdutosContext);
